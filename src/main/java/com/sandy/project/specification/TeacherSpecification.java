...
/**
 * Specification class untuk dynamic query filtering Teacher
 * Menggunakan JPA Criteria API untuk build query secara dinamis
 */
public class TeacherSpecification {
    
    /**
     * Build specification berdasarkan TeacherFilterDTO
     ...
     */
    public static Specification<Teacher> filterBy(TeacherFilterDTO filter) {
