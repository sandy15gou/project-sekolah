...
const navItems = [
  ...
  { href: '/teachers', label: 'Guru', icon: TeacherIcon },
  { href: '/students', label: 'Siswa', icon: StudentIcon },
  { href: '/classes', label: 'Kelas', icon: ClassIcon },
  { href: '/subjects', label: 'Mata Pelajaran', icon: SubjectIcon },
  { href: '/schedules', label: 'Jadwal', icon: ScheduleIcon },
  { href: '/scores', label: 'Nilai', icon: ScoreIcon },
];
...
export default function Sidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed top-0 left-0 z-50 h-screen w-[260px] flex flex-col transition-transform duration-300 ease-out lg:translate-x-0',
          'bg-[#0c0c14]/80 backdrop-blur-2xl border-r border-white/[0.06]',
      ...
      >
        ...
        <div className="flex items-center gap-3 px-6 h-16 border-b border-white/[0.06]">
          ...
          <div>
            <h1 className="text-sm font-bold text-white tracking-tight">EduManager</h1>
            <p className="text-[10px] text-white/40 font-medium">Sistem Manajemen Sekolah</p>
          </div>
        </div>
        ...
        <div className="px-4 py-4 border-t border-white/[0.06]">
          <p className="text-[10px] text-white/20 text-center">EduManager v1.0</p>
        </div>
      </aside>
    </>
  );
